...
def main(args):
    ...
    params = {
        ...
        "VAL"     : f"/home/dohyun/tutorial/val_s",
        "TEST"    : f"{data_path}/test_s",
        "DIR"     : f"{data_path}",
        "DATCUT"  : "2030-Jan-01",
...
if __name__ == "__main__":
    ...
    root = '/public_data/ml/CATH40/CATH40-20JUN08/pdb'

    argparser.add_argument("--path_for_training_data", type=str, default="/public_data/ml/CATH40/CATH40-20JUN08/pdb", help="path for loading training data") 
